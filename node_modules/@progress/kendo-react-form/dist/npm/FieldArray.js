 ...
 */
exports.FieldArray = function (props) {
    ...
    return React.createElement(component, __assign({ 
        ...
        valid: !(Boolean(form.errors[name]) && form.touched[name]), onUnshift: onUnshift, onPush: onPush, onInsert: onInsert, onPop: onPop, onRemove: onRemove, onReplace: onReplace, onMove: onMove, children: children }, others));
};
